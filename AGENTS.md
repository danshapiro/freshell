...
- See `docs/development/codex-resume-tracking.md` for the three codex identity lanes (startup locator, disk fork watch, D-RESUME proxy arm), the shared adopt/rebind tail, and the recovery funnel.
