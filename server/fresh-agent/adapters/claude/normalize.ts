...
export function normalizeClaudeTurn(
  input: Pick<AgentTimelineTurn, 'turnId' | 'messageId' | 'ordinal' | 'source' | 'message'>,
...
function isSyntheticUserTimelineItem(item: Pick<AgentTimelinePage['items'][number], 'role' | 'summary'>): boolean {
