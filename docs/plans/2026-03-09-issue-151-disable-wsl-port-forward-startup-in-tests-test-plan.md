...
1. `npx vitest run --config config/vitest/vitest.server.config.ts test/unit/server/wsl-port-forward-startup.test.ts test/integration/server/wsl-port-forward.test.ts test/integration/server/logger.separation.harness.test.ts`
...
1. `npx vitest run --config config/vitest/vitest.server.config.ts test/unit/server/wsl-port-forward-startup.test.ts test/unit/server/wsl-port-forward.test.ts test/integration/server/wsl-port-forward.test.ts test/integration/server/logger.separation.harness.test.ts test/integration/server/logger.separation.test.ts`
