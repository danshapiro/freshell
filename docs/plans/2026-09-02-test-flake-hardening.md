...
> 2026-09-05: SUPERSEDED — mechanism-B fixed by docs/plans/2026-09-05-auto-resume-hub-grace.md (kata kmbs); the waiver classifier is deleted (certification is strict: any FAIL blocks).
...
> 2026-09-05: superseded: plain FAIL-blocks certification — scripts/classify-resume-waiver.ts is deleted, so a failed run simply blocks (kata kmbs, docs/plans/2026-09-05-auto-resume-hub-grace.md).
...
> 2026-09-05: addition #5's deferred follow-up task LANDED as kata kmbs — FIXED by docs/plans/2026-09-05-auto-resume-hub-grace.md (bounded identity-grace in the hub); the waiver rule above is retired (any FAIL blocks).
