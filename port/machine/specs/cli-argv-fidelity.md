...
- Strip from the parent env: `CLAUDECODE, CI, NO_COLOR, FORCE_COLOR, COLOR, PORT, AUTH_TOKEN, ALLOWED_ORIGINS, FRESHELL_CONFIG_DIR, FRESHELL_PROFILE, NODE_ENV, npm_lifecycle_script, OPENCODE_SERVER_USERNAME, OPENCODE_SERVER_PASSWORD` (`:1083-1097`). Already ported: `spawn.rs:165-178` (`STRIP_ENV`).
