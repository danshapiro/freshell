...
describe('ws tabs registry protocol', () => {
  ...
  it(`uses the pinned protocol version (WS_PROTOCOL_VERSION) and rejects version N-1 clients with reload-required mismatch`, async () => {
    expect(WS_PROTOCOL_VERSION).toBe(10)
