    ...
    const promise = new Promise<void>((resolve, reject) => {
      ...
      this.ws.onopen = () => {
        ...
        this.sendNow({
          ...
          capabilities: { uiScreenshotV1: true, terminalOutputBatchV1: true, terminalInterestV1: true, paneReconcileV1: true, paneReconcileFreshAgentV1: true, managedRuntimeV1: true },
          ...helloExtensions,
        })
      }
